...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            html.H2("GT Position Data (X vs Y, Last {} seconds)".format(TIME_WINDOW), style={"marginBottom": "1px"}),
            dcc.Graph(id='gt-graph', style={"height": "1000px", "width": "1000px"}),
        ], style={"width": "50%", "display": "inline-block"}),

        html.Div([
            html.Div([
                html.H2("IMU Acceleration Data (Last {} seconds)".format(TIME_WINDOW),style={"marginBottom": "1px"}),
                dcc.Graph(id='imu-graph', style={"height": "400px", "width": "400px"}),
            ], style={"padding": "10px"}),

            html.Div([
                html.H2("VLP RSS Data (Last {} seconds)".format(TIME_WINDOW),style={"marginBottom": "1px"}),
                dcc.Graph(id='vlp-graph', style={"height": "400px", "width": "400px"}),
            ], style={"padding": "5px"}),
